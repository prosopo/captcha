...
pub mod captcha {
    ...
    impl Captcha {
        ...
        pub fn get_git_commit_id(&self) -> [u8; 20] {
            let env_git_commit_id: [u8; 20] = [133,23,238,65,185,230,61,82,239,114,178,142,198,117,72,155,66,152,64,78];
            env_git_commit_id
        }
    ...
    mod tests {
        ...
        fn test_dapp_register_and_update() {
            ...
            // tokens
            contract.dapp_update(dapp_contract, DappPayee::Any, caller);
        ...
        fn test_get_random_active_provider_dapp_any() {
            ...
            let balance = 2000000000000;
            ink::env::test::set_value_transferred::<ink::env::DefaultEnvironment>(balance);
            contract.dapp_register(dapp_contract, DappPayee::Any);
