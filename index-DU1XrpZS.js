...
const l4 = ae.lazy(async () => import("./ProcaptchaWidget-BfqnMHY0.js")), hx = (e) => $(ae.Suspense, { fallback: $(Wu, { darkMode: e.config.theme }), children: $(l4, { config: e.config, callbacks: e.callbacks }) }), u4 = ae.lazy(async () => import("./ProcaptchaWidget-DlGRz6Tc.js")), mx = (e) => $(ae.Suspense, { fallback: $(Wu, { darkMode: e.config.theme }), children: $(u4, { config: e.config, callbacks: e.callbacks }) }), c4 = async () => await ig().then((e) => ({ bot: e.isBot })), d4 = ({ config: e, callbacks: t, detectBot: n = c4 }) => {
