import { A as ApiParams, e as encodeProcaptchaOutput, P as ProcaptchaConfigSchema, r as reactExports, i as instance, j as jsx, W as WIDGET_MAX_WIDTH, C as ContainerDiv, c as WidthBasedStylesDiv, b as jsxs, f as WIDGET_DIMENSIONS, g as WIDGET_PADDING, h as WIDGET_BORDER, k as WIDGET_BORDER_RADIUS, m as WIDGET_INNER_HEIGHT, L as LoadingSpinner, n as WIDGET_URL, o as WIDGET_URL_TEXT, p as Logo, l as lightTheme, d as darkTheme } from "./index-Dy2zRU-i.js";
import { n as sha256, g as getDefaultEvents, p as providerRetry, d as buildUpdateState, f as sleep, b as ProsopoEnvError, i as getRandomActiveProvider, j as ProviderApi, s as stringToHex, E as ExtensionWeb2, k as ExtensionWeb3, l as useTranslation, m as useProcaptcha, C as Checkbox } from "./utils-y5cXAMsc.js";
...
const Procaptcha = (props) => {
  ...
  return jsx("div", { ref: captchaRef, children: jsx("div", { style: {
    ...
    display: "flex"
  }, children: jsx("div", { style: { flex: 1 }, children: state.loading ? jsx(LoadingSpinner, { themeColor, "aria-label": "Loading spinner" }) : jsx(Checkbox, { checked: state.isHuman, onChange: manager.current.start, themeColor, labelText: t("WIDGET.I_AM_HUMAN"), error: state.error, "aria-label": "human checkbox" }) }) }) }) }) }), jsx("div", { style: { display: "inline-flex", flexDirection: "column" }, children: jsx("a", { href: WIDGET_URL, target: "_blank", "aria-label": WIDGET_URL_TEXT, rel: "noreferrer", children: jsx("div", { style: { flex: 1 }, children: jsx(Logo, { themeColor, "aria-label": "Prosopo logo" }) }) }) })] })] }) }) }) }) });
};
export {
