...
// PoW (ProcaptchaPow) and puzzle (ProcaptchaPuzzle) sibling wrappers so any prop the inner widget consumes
// can never be silently dropped by this Suspense wrapper.
export const ProcaptchaIconOrder = (props: ProcaptchaProps) => (
	<Suspense>
