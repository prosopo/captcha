...
import { ProsopoConfig } from './types/api';

const config: ProsopoConfig = {
    // "providerApi.baseURL": process.env.API_BASE_URL,
    // "providerApi.prefix": process.env.API_PATH_PREFIX,
    // "dappAccount": process.env.DAPP_CONTRACT_ADDRESS,
