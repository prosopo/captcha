...
import { createCheckboxElement, getCheckboxInteractiveArea } from "./elements/checkbox.js";
...
describe("types", () => {
    ...
    describe("getCheckboxInteractiveArea types", () => {
        ...
        test("getCheckboxInteractiveArea accepts HTMLElement", () => {
            expectTypeOf(getCheckboxInteractiveArea).parameter(0).toMatchTypeOf<HTMLElement>();
        });
    });
    ...
    describe("createWidgetSkeletonElement types", () => {
        ...
        test("createWidgetSkeletonElement accepts Theme", () => {
            expectTypeOf(createWidgetSkeletonElement).parameter(0).toMatchTypeOf<Theme>();
        });
    });
    ...
    describe("createWebComponent types", () => {
        ...
        test("createWebComponent accepts optional string as customCss", () => {
            expectTypeOf(createWebComponent).parameter(1).toMatchTypeOf<string | undefined>();
        });

        test("createWebComponent with customCss", () => {
            const component = createWebComponent("test-widget", ".custom { color: red; }");
            expectTypeOf(component).toMatchTypeOf<HTMLElement>();
        });
    });
    ...
    describe("constants types", () => {
        ...
        test("WIDGET_CHECKBOX_SPINNER_CSS_CLASS type", () => {
            expectTypeOf<typeof WIDGET_CHECKBOX_SPINNER_CSS_CLASS>().toMatchTypeOf<string>();
