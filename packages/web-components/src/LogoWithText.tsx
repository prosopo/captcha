...
export const LogoWithText: React.FC<LogoWithoutTextProps> = ({
  themeColor,
  ...
  return (
    ...
    >
      ...
      <g id="g1960" transform="translate(0,-35.903035)">
        <g
          id="g943"
          transform="matrix(0.82220888,0,0,0.82220888,103.56268,35.903035)"
        >
          <path
            className="cls-1"
            d="m 335.55,1825.19 a 147.75,147.75 0 0 1 147.75,147.75 h 50.5 c 0,-109.49 -88.76,-198.25 -198.25,-198.25 z"
            transform="translate(-215.73,-1774.69)"
            id="path8"
          />
          <path
            className="cls-1"
            d="m 269.36,1891.39 a 147.74,147.74 0 0 1 147.74,147.74 h 50.5 c 0,-109.49 -88.75,-198.24 -198.24,-198.24 z"
            transform="translate(-215.73,-1774.69)"
            id="path10"
          />
          <path
            className="cls-1"
            d="M 414,2157.17 A 147.75,147.75 0 0 1 266.26,2009.43 h -50.5 c 0,109.49 88.75,198.24 198.24,198.24 z"
            transform="translate(-215.73,-1774.69)"
            id="path12"
          />
          <path
            className="cls-1"
            d="M 480.17,2091 A 147.74,147.74 0 0 1 332.43,1943.25 h -50.51 c 0,109.49 88.76,198.25 198.25,198.25 z"
            transform="translate(-215.73,-1774.69)"
            id="path14"
          />
        </g>
