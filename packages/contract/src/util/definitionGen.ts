...
//         let definition = ''
//         if (fieldTypesArr && fieldTypesArr.length > 0 && at(at(fieldTypesArr, 0), 0)) {
//             const outerLayer = 0
//             let innerLayer = outerLayer + 1
//             let outerType = at(at(fieldTypesArr, outerLayer), 0)
//             let outerParams = outerType.type.params
//             let outerPath = outerType.type.path
//             let innerType = at(at(fieldTypesArr, outerLayer), 0)
//
...
//                 innerType = at(at(fieldTypesArr, innerLayer), 1)
...
//                             definition += `${defStr(outerType)}<${defStr(
//                                 at(at(fieldTypesArr, innerLayer), 0)
//                             )}<${defStr(at(at(fieldTypesArr, innerLayer), 1))},`
//                         }
//                         innerLayer++
//                         outerType = at(at(fieldTypesArr, innerLayer), 0)
//                         innerType = at(at(fieldTypesArr, innerLayer), 1)
...
//                     }
//                 } else {
//                     const inner1 = at(at(fieldTypesArr, innerLayer), 0)
//                     const inner2 = at(at(fieldTypesArr, innerLayer), 1)
//                     definition = `${defStr(outerType)}<${defStr(inner1)},${defStr(inner2)}>`
//                 }
//             } else {
//                 definition += defStr(
//                     outerType,
//                     fieldTypesArr[innerLayer] ? at(at(fieldTypesArr, innerLayer), 0) : undefined
//                 )
//             }
//         }
...
//     return `${capitalizeFirstLetter(snakeCaseToCamelCase(at(path.slice(-2), 0)))}${path.slice(-1)[0]}`
// }
//
...
//  * @param path
//  */
// export function generateDefinitions(abiJson: string, path: string[]): TypegenDefinitions {
...
//     const storageDefinitions = storageTypesToDefinitions(storageTypes, at(path.slice(-2), 0))
//     return { types: { ...storageDefinitions, ...typeDefinitions } }
// }
//
// console.log(JSON.stringify(generateDefinitions(ContractAbi, ['prosopo', 'prosopo']), null, 4))
