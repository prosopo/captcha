...
export default class Methods {
	...
	*/
	"forward" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "forward", [], __options , (result) => { return handleReturnType(result, getTypeDescription(7, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"handler" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "handler", [msg], __options , (result) => { return handleReturnType(result, getTypeDescription(13, DATA_TYPE_DESCRIPTIONS)); });
	}
