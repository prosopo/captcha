...
export default class Methods {
     ...
     */
    verifySr25519(signature: Array<number | string | BN>, payload: Array<number | string | BN>, __options?: GasLimit) {
     ...
     */
    providerSetDataset(datasetId: ArgumentTypes.Hash, datasetIdContent: ArgumentTypes.Hash, __options?: GasLimit) {
        return txSignAndSend(
            this.__apiPromise,
            this.__nativeContract,
            this.__keyringPair,
     ...
     */
    dappOperatorIsHumanUser(user: ArgumentTypes.AccountId, threshold: number | string | BN, __options?: GasLimit) {
        return txSignAndSend(
            this.__apiPromise,
            this.__nativeContract,
            this.__keyringPair,
     ...
     * @param { ArgumentTypes.AccountId } user,
     */
    dappOperatorLastCorrectCaptcha(user: ArgumentTypes.AccountId, __options?: GasLimit) {
        return txSignAndSend(
            this.__apiPromise,
            this.__nativeContract,
            this.__keyringPair,
     ...
     */
    getDappUser(dappUserId: ArgumentTypes.AccountId, __options?: GasLimit) {
        return txSignAndSend(
            this.__apiPromise,
            this.__nativeContract,
            this.__keyringPair,
     ...
     */
    getProviderDetails(accountid: ArgumentTypes.AccountId, __options?: GasLimit) {
        return txSignAndSend(
            this.__apiPromise,
            this.__nativeContract,
            this.__keyringPair,
     ...
     * @param { ArgumentTypes.AccountId } contract,
     */
    getDappDetails(contract: ArgumentTypes.AccountId, __options?: GasLimit) {
        return txSignAndSend(
            this.__apiPromise,
            this.__nativeContract,
            this.__keyringPair,
     ...
     */
    getCaptchaSolutionCommitment(captchaSolutionCommitmentId: ArgumentTypes.Hash, __options?: GasLimit) {
        return txSignAndSend(
            this.__apiPromise,
            this.__nativeContract,
            this.__keyringPair,
     ...
     */
    getDappBalance(dapp: ArgumentTypes.AccountId, __options?: GasLimit) {
        return txSignAndSend(
            this.__apiPromise,
            this.__nativeContract,
            this.__keyringPair,
     ...
     */
    getProviderBalance(provider: ArgumentTypes.AccountId, __options?: GasLimit) {
        return txSignAndSend(
            this.__apiPromise,
            this.__nativeContract,
            this.__keyringPair,
     ...
     */
    listProvidersByIds(providerIds: Array<ArgumentTypes.AccountId>, __options?: GasLimit) {
        return txSignAndSend(
            this.__apiPromise,
            this.__nativeContract,
            this.__keyringPair,
     ...
     *
     */
    getAllProviderIds(__options?: GasLimit) {
        return txSignAndSend(
            this.__apiPromise,
            this.__nativeContract,
            this.__keyringPair,
     ...
     */
    setAdmin(newAdmin: ArgumentTypes.AccountId, __options?: GasLimit) {
        return txSignAndSend(
            this.__apiPromise,
            this.__nativeContract,
            this.__keyringPair,
