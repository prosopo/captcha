...
export class Tasks {
    ...
    async providerApprove(captchaSolutionCommitmentId): Promise<DecodedEvent[]> {
        return await this.contractApi.contractTx('providerApprove', [captchaSolutionCommitmentId])
    }
