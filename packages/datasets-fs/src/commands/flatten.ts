...
import { IOArgsSchema as IOArgsSchema, IOCliBuilder } from '../utils/utils.js'
...
export const ArgsSchema = IOArgsSchema.extend({})
export type ArgsSchemaType = typeof ArgsSchema
export type Args = z.infer<ArgsSchemaType>
export class Flatten extends IOCliBuilder<ArgsSchemaType> {
