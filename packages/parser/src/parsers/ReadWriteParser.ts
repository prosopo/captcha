...
export class ReadWriteParser<T extends Parser<any>> extends Parser<Shape<T>> implements NestedParser<T>, ReadonlyProp<false> {
    ...
    public override clone() {
        return new ReadWriteParser<T>(this.parser)
    }
