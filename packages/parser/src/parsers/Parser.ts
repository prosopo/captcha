...
export interface OptionalProp<P> {
    readonly optional: P
}
export interface ReadonlyProp<P> {
    readonly readonly: P
}
...
// same for readonly
export type IsReadonly<T> = T extends ReadonlyProp<infer P> ? P : T extends NestedParser<infer U> ? IsReadonly<U> : false