...
export class FunctionParser<T extends Parser<any>[], U> {
    ...
    constructor(readonly args: T | null = null, readonly returnType: Parser<U> | null = null) {
...
type UnpackParserArray<T> = T extends [Parser<infer A>, ...infer B] ? [A, ...UnpackParserArray<B>] : []
type UnpackReturnType<T> = T extends Parser<infer U> ? U : never
type ToFn<T extends Parser<any>[], U = void> = (...args: UnpackParserArray<T>) => U

type a1 = ToFn<[Parser<string>, Parser<number>]>
type a2 = ToFn<[], string>
