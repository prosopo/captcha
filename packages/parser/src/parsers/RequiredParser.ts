...
export class RequiredParser<T extends Parser<any>> extends Parser<Exclude<Shape<T>, undefined>> implements NestedParser<T>, OptionalProp<false> {
    ...
    public override clone() {
        return new RequiredParser<T>(this.parser)
    }
