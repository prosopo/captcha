...
//         expectTypeOf(() => p().validate(null)).returns.toMatchTypeOf<Map<string, number>>();
//         const parser = p();
...
//         expect(p().validate(new Map([["a", 1], ["b", 2], ["c", 3]]))).toStrictEqual(new Map([["a", 1], ["b", 2], ["c", 3]]));
//     })

//     it("should error on Map with invalid key type", () => {
//         expect(() => p().validate(new Map<string | number, number>([[1, 1], ["b", 2], ["c", 3]]) as any)).toThrow();
//     })

//     it("should error on Map with invalid value type", () => {
//         expect(() => p().validate(new Map<string, string | number>([["a", "1"], ["b", 2], ["c", 3]]) as any)).toThrow();
//     })

//     it("should parse Map", () => {
//         expect(p().validate(new Map())).toStrictEqual(new Map());
//     })
