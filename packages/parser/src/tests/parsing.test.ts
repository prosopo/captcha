...
describe("boolean", () => {
    ...
    test("coerces", () => {
        expect(pBoolean().parse(undefined, { coerce: true })).to.equal(NaN);
        expect(pBoolean().parse(null, { coerce: true })).to.equal(0);
        expect(pBoolean().parse("", { coerce: true })).to.equal(0);
        expect(pBoolean().parse(true, { coerce: true })).to.equal(1);
        expect(pBoolean().parse(false, { coerce: true })).to.equal(0);
