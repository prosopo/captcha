...
export const DEFAULT_POW_CAPTCHA_VERIFIED_TIMEOUT =
...
export const DEFAULT_POW_CAPTCHA_CACHED_TIMEOUT =
	DEFAULT_POW_CAPTCHA_SOLUTION_TIMEOUT * 3;
// The timeframe in which a puzzle captcha solution remains valid on the page before timing out (1 minute)
export const DEFAULT_PUZZLE_CAPTCHA_SOLUTION_TIMEOUT = ONE_MINUTE;
// The timeframe in which a puzzle captcha must be completed and verified (2 minutes)
export const DEFAULT_PUZZLE_CAPTCHA_VERIFIED_TIMEOUT =
	DEFAULT_PUZZLE_CAPTCHA_SOLUTION_TIMEOUT * 2;
...
// The timeframe in which a connect captcha solution remains valid on the page
// before timing out (1 minute). Reading a board and making one drag is not
// slower than a slider drag, so the connect windows mirror the puzzle's.
export const DEFAULT_CONNECT_CAPTCHA_SOLUTION_TIMEOUT = ONE_MINUTE;
// The timeframe in which a connect captcha must be completed and verified (2 minutes)
export const DEFAULT_CONNECT_CAPTCHA_VERIFIED_TIMEOUT =
	DEFAULT_CONNECT_CAPTCHA_SOLUTION_TIMEOUT * 2;
// The time in milliseconds that a Provider cached, verified, connect captcha solution is valid for (3 minutes)
export const DEFAULT_CONNECT_CAPTCHA_CACHED_TIMEOUT =
	DEFAULT_CONNECT_CAPTCHA_SOLUTION_TIMEOUT * 3;
