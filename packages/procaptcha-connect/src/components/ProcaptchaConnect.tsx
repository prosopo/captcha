...
// Spread props rather than enumerating: matches the image (Procaptcha), PoW
// (ProcaptchaPow) and puzzle (ProcaptchaPuzzle) sibling wrappers so any prop
// the inner widget consumes can never be silently dropped by this Suspense
// wrapper.
export const ProcaptchaConnect = (props: ProcaptchaProps) => (
	<Suspense>
