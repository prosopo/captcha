...
const MOCK_ITEMS = calculateItemHashes(
    new Array(9).fill(0).map((_, i) => ({
        data: path.join(process.cwd(), `/tests/js/mocks/data/img/01.0${i + 1}.jpeg`),
...
const RECEIVED: CaptchaSolution[] = [
    {
        captchaId: '0x531ba1d454a66745e6d51138733a9f5f3e057f1141b7ea723ebd33d567a937a1',
        captchaContentId: '',
        solution: matchItemsToSolutions([0, 1, 2], MOCK_ITEMS),
        salt: '',
    },
    {
        captchaId: '0xede7365e941e1c5d875a2324d70a08b029f66792c1508c3bddb49bd646484494',
        captchaContentId: '',
        solution: matchItemsToSolutions([0, 1, 2], MOCK_ITEMS),
        salt: '',
    },
