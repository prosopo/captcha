import { b as ProsopoEnvError, A as ApiParams, e as encodeProcaptchaOutput, d as ProcaptchaConfigSchema, r as reactExports, i as instance, j as jsx, W as WIDGET_MAX_WIDTH, C as ContainerDiv, h as WidthBasedStylesDiv, g as jsxs, k as WIDGET_DIMENSIONS, m as WIDGET_PADDING, n as WIDGET_BORDER, o as WIDGET_BORDER_RADIUS, p as WIDGET_INNER_HEIGHT, L as LoadingSpinner, q as WIDGET_URL, s as WIDGET_URL_TEXT, t as Logo, l as lightTheme, f as darkTheme } from "./index-p-8dY3CU.js";
import { k as sha256, g as getDefaultEvents, p as providerRetry, b as buildUpdateState, d as sleep, e as getRandomActiveProvider, P as ProviderApi, s as stringToHex, E as ExtensionWeb2, f as ExtensionWeb3, i as useTranslation, j as useProcaptcha, C as Checkbox } from "./utils-CLSgJZFH.js";
...
const Procaptcha = (props) => {
  ...
  return jsx("div", { ref: captchaRef, children: jsx("div", { style: {
    ...
    display: "flex"
  }, children: jsx("div", { style: { flex: 1 }, children: state.loading ? jsx(LoadingSpinner, { themeColor, "aria-label": "Loading spinner" }) : jsx(Checkbox, { checked: state.isHuman, onChange: manager.current.start, themeColor, labelText: t("WIDGET.I_AM_HUMAN"), "aria-label": "human checkbox" }) }) }) }) }) }), jsx("div", { style: { display: "inline-flex", flexDirection: "column" }, children: jsx("a", { href: WIDGET_URL, target: "_blank", "aria-label": WIDGET_URL_TEXT, rel: "noreferrer", children: jsx("div", { style: { flex: 1 }, children: jsx(Logo, { themeColor, "aria-label": "Prosopo logo" }) }) }) })] })] }) }) }) }) });
};
export {
