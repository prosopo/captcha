import { z, P as ProsopoError, a as at, b as ProsopoEnvError, c as ProsopoDatasetError, e as encodeProcaptchaOutput, A as ApiParams, d as ProcaptchaConfigSchema, r as reactExports, l as lightTheme, f as darkTheme, j as jsx, g as jsxs, R as React, i as instance, W as WIDGET_MAX_WIDTH, C as ContainerDiv, h as WidthBasedStylesDiv, k as WIDGET_DIMENSIONS, m as WIDGET_PADDING, n as WIDGET_BORDER, o as WIDGET_BORDER_RADIUS, p as WIDGET_INNER_HEIGHT, L as LoadingSpinner, q as WIDGET_URL, s as WIDGET_URL_TEXT, t as Logo } from "./index-QQFsvwc2.js";
import { u as u8aToString, h as hexToU8a, a as hexHashArray, s as stringToHex, g as getDefaultEvents, p as providerRetry, b as buildUpdateState, c as cryptoWaitReady, d as sleep, e as getRandomActiveProvider, r as randomAsHex, P as ProviderApi, E as ExtensionWeb2, f as ExtensionWeb3, i as useTranslation, j as useProcaptcha, C as Checkbox } from "./utils-LWgdamgd.js";
...
const ProcaptchaWidget = (props) => {
  ...
  }, children: jsx(Checkbox, { themeColor, onChange: manager.start, checked: state.isHuman, labelText: t("WIDGET.I_AM_HUMAN"), "aria-label": "human checkbox" }) }), jsx("div", { style: {
    display: state.loading ? "flex" : "none"
