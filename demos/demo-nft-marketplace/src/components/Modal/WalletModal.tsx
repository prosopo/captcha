...
function WalletModal({ ...modalProps }: Props) {
  ...
  return (
    ...
    >
      ...
      <Button fullWidth title="Reload" icon={ReloadIcon} type={ButtonType.Secondary} onClick={() => router.reload()} />
      <p className="mt-4 text-sm font-semibold text-white">NOTE: Using more than one extension may cause issues.</p>
    </Modal>
  );
}
